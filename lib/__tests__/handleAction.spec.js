...
describe('Given the handleAction function', function () {
  ...
  describe('when dispatching an action which is missing in the current state', function () {
    it('should throw an error', function () {
      ...
      expect(_handleAction2.default.bind(null, machine, 'stop', 'a', 'b')).to.throw((0, _constants.ERROR_MISSING_ACTION_IN_STATE)('stop', 'idle', 'a,b'));
    });
  });
              ...
              while (1) {
                switch (_context10.prev = _context10.next) {
                  ...
                  case 7:
                    ...
                    return _context10.abrupt('return', 'the answer is ' + answer + ': ' + a + ' + ' + b);
